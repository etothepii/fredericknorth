...
public class RouteBuilderMapFrameModel {
    ...
    private final WardsModel wardsModel;
    ...
    public RouteBuilderMapFrameModel(ApplicationContext applicationContext) {
        this.council = applicationContext.getDefaultInstance(Council.class);
        ...
        wardsModel = new WardsModel(this);
    ...
    public WardsModel getWardsModel() {
        return wardsModel;
    }
