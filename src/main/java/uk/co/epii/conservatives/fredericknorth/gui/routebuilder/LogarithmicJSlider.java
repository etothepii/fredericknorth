 ...
 * logarithmic scale. Major and minor ticks are drawn for logarithmic
 * scale as well.
 *
 * @author Greg Hinkle (ghinkle@users.sourceforge.net), Apr 10, 2004
 * @version $Revision: 1.3 $($Author: ghinkl $ / $Date: 2004/10/05 05:16:18 $)
 */
class LogarithmicJSlider extends JSlider {
